...
Edit `catalog/research_structures.csv` for labs, doctoral formations, research centers, and AI research groups.
...
- [ ] The source fields are filled in the same CSV row
